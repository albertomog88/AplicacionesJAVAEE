...
public class Ficha extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) 
		...
		try(PrintWriter out = response.getWriter()){
			...
			out.println("<h4>Mails:"+request.getParameter("email")+"</h4>");
			int reg = Integer.parseInt(request.getParameter("registrado"));
			String texto = (reg==1)?"YA REGISTRADO":"No estas registrado";
